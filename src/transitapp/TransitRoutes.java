...
/**
 * This class represents a transit route (bus or subway).
 * Each consisting of a String that represents the name of the transit route, 
 * an ArrayList of Locations representing a route,
 * an ArrayList of LocalTime representing a schedule, and fares for the bus and subway.
 */
public class TransitRoutes extends Observable{
	 ...
	 * @param route ArrayList of Locations representing each stop or station in the route
	 * @param schedule ArrayList of LocalTime representing when each transit vehicle comes
	 */
	 ...
	 * @return ArrayList of Locations representing the route this transit route takes
	 */
	 ...
	 * @return ArrayList of LocalTime representing when each bus arrives at each location in route
	 */
	...
	/**
	 * A method to set a new route for this transit route. This method 
	 * also adds each location in the new route to an observer.
